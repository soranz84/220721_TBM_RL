...
episodes = 250 # Number of episodes
...
plt.legend(['Episode ' + str(insp_ep_1+1),
            ...
            'Episode ' + str(insp_ep_5+1)],fancybox=False,edgecolor='0',prop=font,loc='upper left',facecolor='white', framealpha=1,ncol=1)
...
plt.xticks(family='Times new roman',size=10)
plt.yticks(family='Times new roman',size=10)
plt.plot(x_surf_his[insp_ep_1][:len(pf_TBM_his[insp_ep_1])],pf_TBM_his[insp_ep_1],linewidth=1,alpha=0.5,color='tab:blue')
...
plt.xticks(family='Times new roman',size=10)
plt.yticks(family='Times new roman',size=10)
plt.plot(x_surf_his[insp_ep_2][:len(pf_TBM_his[insp_ep_2])],pf_TBM_his[insp_ep_2],linewidth=1,alpha=0.5,color='tab:orange')
...
plt.xticks(family='Times new roman',size=10)
plt.yticks(family='Times new roman',size=10)
plt.plot(x_surf_his[insp_ep_3][:len(pf_TBM_his[insp_ep_3])],pf_TBM_his[insp_ep_3],linewidth=1,alpha=0.5,color='tab:green')
...
plt.xticks(family='Times new roman',size=10)
plt.yticks(family='Times new roman',size=10)
plt.plot(x_surf_his[insp_ep_4][:len(pf_TBM_his[insp_ep_4])],pf_TBM_his[insp_ep_4],linewidth=1,alpha=0.5,color='tab:red')
...
plt.xticks(family='Times new roman',size=10)
plt.yticks(family='Times new roman',size=10)
plt.plot(x_surf_his[insp_ep_5][:len(pf_TBM_his[insp_ep_5])],pf_TBM_his[insp_ep_5],linewidth=1,alpha=0.5,color='tab:purple')
